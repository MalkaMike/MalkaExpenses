#!/usr/bin/env node
/**
 * Applies migration 0032_merchant_research_ficha.sql via Supabase Management API.
 * Reads SUPABASE_ACCESS_TOKEN + SUPABASE_PROJECT_REF from ~/.claude/secrets.local.env
 * Run: node scripts/run-migration-032.mjs
 */
...
const sql = readFileSync(path.resolve(__dir, "../db/migrations/0032_merchant_research_ficha.sql"), "utf8");
...
console.log("✅  Migration 0032_merchant_research_ficha applied successfully");
