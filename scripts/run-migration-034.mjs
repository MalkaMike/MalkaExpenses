#!/usr/bin/env node
/**
 * Applies migration 0034_suspeito_tag.sql via Supabase Management API.
 * Reads SUPABASE_ACCESS_TOKEN + SUPABASE_PROJECT_REF from ~/.claude/secrets.local.env
 * Run: node scripts/run-migration-034.mjs
 */
...
const sql = readFileSync(path.resolve(__dir, "../db/migrations/0034_suspeito_tag.sql"), "utf8");
...
console.log("✅  Migration 0034_suspeito_tag applied successfully");
