...
// POST /api/admin/merchants/[key]/unhide
// Sets shared_amount = real_amount for all transactions of this merchant cluster.
export async function POST(
  ...
  await writeAudit("merchant.unhide", { newValue: { canonical_key, updated: updatedCount } });
