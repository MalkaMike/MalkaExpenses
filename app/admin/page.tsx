...
import { CheckCircle2, Mail, Receipt, ChevronRight, RefreshCw, Download, Sparkles, Repeat2, CreditCard } from "lucide-react";
          ...
          <div className="rounded-xl border border-outline-variant bg-surface-container-lowest overflow-hidden">
            <div className="p-3 space-y-1">
              ...
              <Link
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-surface-container transition text-left"
              >
                <CreditCard size={16} className="text-on-surface-variant shrink-0" />
                <span className="text-sm text-on-surface flex-1">Faturas do Cartão</span>
                <ChevronRight size={14} className="text-on-surface-variant shrink-0" />
              </Link>
            </div>
          </div>
